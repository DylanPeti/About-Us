...
class acf_field_repeater extends acf_field
{
	...
	*/
	...
	{
		$newdir = "/wp-content/plugins/advanced-custom-fields/";
		// register acf scripts
		wp_register_script( 'acf-input-repeater', $newdir . 'js/input.js', array('acf-input'), $this->settings['version'] );
		wp_register_style( 'acf-input-repeater', $newdir . 'css/input.css', array('acf-input'), $this->settings['version'] ); 
