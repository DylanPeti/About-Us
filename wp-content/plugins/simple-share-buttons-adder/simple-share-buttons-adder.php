...
function ssba_twitter($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
	...
	//$htmlShareButtons = '<a class="ssba_twitter_share" href="http://twitter.com/share?url=' . $urlCurrentPage . '&amp;text=' . $twitterShareText . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? 'rel="nofollow"' : NULL) . '>';
     ...
     $htmlShareButtons = '<a id="ssba_twitter_share" href=\'javascript:PopUp("http://twitter.com/share?url=' . $urlCurrentPage . '")\'>';
...
function ssba_google($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
	...
	$htmlShareButtons = '<a id="ssba_google_share" href=\'javascript:PopUp("https://plus.google.com/share?url=' . $urlCurrentPage . '")\'>';
...
function ssba_linkedin($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
	...
	$htmlShareButtons = '<a id=""ssba_linkedin_share ssba_share_link" href=\'javascript:PopUp("http://www.linkedin.com/shareArticle?mini=true&amp;url=' . $urlCurrentPage . '")\'>';
