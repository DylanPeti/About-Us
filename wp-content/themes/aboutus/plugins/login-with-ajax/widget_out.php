            ...
            <table>
                <tr class="lwa-username">
                    <td class="lwa-username-label">
                        <label><?php esc_html_e( 'Username or email','login-with-ajax' ) ?></label>
                    </td>
                ...
                <tr class="lwa-submit">
                    <td class="lwa-submit-button custom-login-submit">
                    ...
                    <td class="lwa-submit-links custom-rememberme">
						...
						<a class="lwa-links-remember" href="<?php echo esc_attr(LoginWithAjax::$url_remember); ?>" title="<?php esc_attr_e('Password Lost and Found','login-with-ajax') ?>"><?php esc_attr_e('Lost password?','login-with-ajax') ?></a>
						<?php endif; ?>
