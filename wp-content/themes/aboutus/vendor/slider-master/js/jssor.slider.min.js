    ...
    var k = f.$JssorEasing$ = {
        ...
        m, i, a = f.$Jssor$ = new function() {
            ...
            function X(e, a) {
                ...
                if (A()) {
                    ...
                    if (j) {
                        ...
                        if (db() && D > 535 && "ontouchstart" in f) k += " perspective(0px)";
                        e.style[j] = k
                    }
                }
            }
            i.$SetStyleTransform = function(b, a) {
                if (Z()) pb(i.$CreateCallback(g, X, b, a));
                else X(b, a)
            };
            ...
            i.$EnableHWA = function(a) {
                if (!a.style[u(a)] || a.style[u(a)] == "none") a.style[u(a)] = "perspective(0px)"
            };
            ...
            i.$EnableElement = function(a, b) {
                if (b) i.$Attribute(a, "disabled", c);
                else i.$RemoveAttribute(a, "disabled")
            };
        ...
        function m(q, lc) {
                ...
                function R(b, e, d) {
                    ...
                    a.$Each(g, function(g) {
                        ...
                        if (i == "player" && !w) {
                            w = g;
                            if (w.pInstance) M();
                            else a.$AddEvent(w, "dataavailable", M)
                        }
                        if (i == "caption") {
                            if (!a.$IsBrowserIE() && !e) {
                                var h = a.$CloneNode(g);
            ...
            function Cc(h, q, v, u) {
                ...
                b.$Replay = function() {
                    ...
                    if (!C && !S && !t && s == h) {
                        ...
                        var i = T && (!J || G);
                        if (a == f)(e != f && !(J & 12) || i) && p.$GoForNextSlide();
            ...
            function dc(e, g) {
                ...
                if (a.$IsBrowserIE() && a.$BrowserVersion() >= 10 && a.$BrowserVersion() < 11) e.style.msTransform = "translate(" + c + "px, " + d + "px)";
                    ...
                    e.style.WebkitTransform = "translate3d(" + c + "px, " + d + "px, 0px) perspective(0px)"
                } else {
                    a.$CssLeft(e, c);
                    a.$CssTop(e, d)
                }
            ...
            var bb = o.$BulletNavigatorOptions,
                ...
                W = !o.$UISearchMode,
                w, A = a.$FindChild(q, "slides", W),
                jb = a.$FindChild(q, "loading", W) || a.$CreateDiv(e),
                Ob = a.$FindChild(q, "navigator", W),
                hc = a.$FindChild(q, "arrowleft", W),
                ec = a.$FindChild(q, "arrowright", W),
                Nb = a.$FindChild(q, "thumbnavigator", W),
                sc = a.$CssWidth(A),
                rc = a.$CssHeight(A),
                U, Z = [],
                Bc = a.$Children(A);
            ...
            var s = -1,
                ...
                ob, x, N, Eb, hb, X, R = [],
                Ub, Wb, Sb, jc, Ic, T, J = o.$PauseOnHover,
                Zb = o.$SlideDuration,
                wb, kb, mb, Vb = v < t,
                M = Vb ? o.$Loop : 0,
                Q, V, G = 1,
            ...
            o.$ArrowKeyNavigation && a.$AddEvent(e, "keydown", function(a) {
                if (a.keyCode == p.$LEFT) rb(-1);
                else a.keyCode == p.$RIGHT && rb(1)
            });
            var qb = o.$StartIndex;
